      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
        <tr>
          <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding: 0 30px 10px 30px; padding-top: 10px; font-size: 12px; color: #999999;">
            <span class="apple-link" style="color: #999999; font-size: 12px;">Wanaka Concert Society appreciates the support of its donors, subscribers, sponsors and volunteers</span>
          </td>
        </tr>
      </table>
    </div>
