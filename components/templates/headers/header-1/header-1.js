...
//             {/* <Link href="/">
//               <a>
//                 <img className="mr-3" src={`${publicRuntimeConfig.API_URL || ''}${attributes.image.url}`} width={attributes.image.width} height={attributes.image.height} alt="Logo"/>
//               </a>
//             </Link>
//             <Link href="/">
//               <a className="text-xl font-bold text-darkest dark:text-lightest uppercase">{app.displayName}</a>
//             </Link> */}
//           </div>
...
//               {attributes.buttonLinks.map((buttonLink, i) => {
//                 return (
//                   <ButtonLink key={i} attribute={buttonLink}></ButtonLink>
//                 );
//               })}
//             </div>
//           )}
