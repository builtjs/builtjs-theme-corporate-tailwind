    ...
    <section id="cards-2" className="template">
      <div className="max-w-screen-xl px-4 py-16 mx-auto md:py-24 xl:py-32">
        <div className="flex flex-col lg:flex-row">
          {items &&
            items.map((item, i) => (
              <div key={i} className="flex flex-col items-center flex-1 max-w-2xl p-8 mx-auto text-center text-lightest">
                <svg
                  className="w-12 h-12 p-3 mb-8 rounded-lg bg-secondary-light"
                ...
                <h2 className="mb-4 text-2xl font-bold leading-none text-gray-900">{item.heading}</h2>
