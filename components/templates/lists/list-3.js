  ...
  return (
    <article id="list-3" className="template">
      <div className="max-w-screen-xl px-4 mx-auto">
        {heroPost && (
          <div className="flex flex-col pt-28 pb-24 xl:pt-32 lg:flex-row-reverse">
            ...
            <div className="flex-none lg:w-1/3 lg:mr-10 xl:mt-8">
              <div className="flex">
                ...
                <p className="text-sm mb-2">
                  ...
                  {heroPost.category && (
                    <Link href={`/`}>
                    {/* <Link href={`/${contentTypeId}-archive?tag=${tag}`}> */}
                      <a className="text-sm text-secondary hover:underline hover:text-secondary-dark">
                        {heroPost.category}
                      </a>
                    </Link>
                  )}
              ...
              <Link href={url}>
                <a>
                  <h2 className="mb-6 text-4xl font-bold leading-none hover:underline">
                    {heroPost.title}
                  </h2>
                </a>
              </Link>
              <p className="mb-6 font-light leading-loose">
                {heroPost.excerpt}
              </p>
              <Link href={url}>
                <a className="text-secondary-light hover:underline hover:text-secondary">
                  Read Article
                </a>
              </Link>
            </div>
